- dashboard: lookml_test_builder
  title: lookml_test_builder
  layout: newspaper
  preferred_viewer: dashboards-next
  elements:
  - title: order by distribution center
    name: order by distribution center
    model: powered_by
    explore: order_items
    type: looker_bar
  ...
  - title: days to process
    ...
    explore: order_items
    type: looker_column
    fields: [order_items.average_days_to_process, order_items.created_week]
